/*
  ...
  - You are about to drop the column `url_captura` on the `Proyecto` table. All the data in the column will be lost.
...
INSERT INTO "new_Proyecto" ("activo", "cantidad_recursos_asignados", "id", "id_categoria", "id_dependencia_actual", "id_dependencia_origen", "id_subcategoria", "storyline", "tier", "titulo", "url_caratula", "url_ticketera_externa", "url_ticketera_interna", "urls") SELECT "activo", "cantidad_recursos_asignados", "id", "id_categoria", "id_dependencia_actual", "id_dependencia_origen", "id_subcategoria", "storyline", "tier", "titulo", "url_caratula", "url_ticketera_externa", "url_ticketera_interna", "urls" FROM "Proyecto";
DROP TABLE "Proyecto";
