  ...
  return (
    <form action={dispatch} className="bg-white p-8 rounded-lg shadow-md flex flex-col gap-6">
      ...
      <div>
        ...
        <input type="text" name="nombre" id="nombre" required defaultValue={client.nombre} className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
      </div>
      ...
      <div>
        ...
        <input type="email" name="email" id="email" defaultValue={client.email || ''} className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
      </div>

      <div>
        <label htmlFor="celular" className="block text-sm font-medium text-primary mb-1">Celular</label>
        <input type="text" name="celular" id="celular" defaultValue={client.celular || ''} className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
      </div>
      ...
      <div>
        ...
        <input type="date" name="fecha_inicio_desarrollo" id="fecha_inicio_desarrollo" defaultValue={client.fecha_inicio_desarrollo?.toISOString().split('T')[0] || ''} className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
      </div>

      <div>
        <label htmlFor="observacion" className="block text-sm font-medium text-primary mb-1">Observación</label>
        <textarea name="observacion" id="observacion" rows={3} defaultValue={client.observacion || ''} className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"></textarea>
      </div>

      <div className="flex items-center">
          <input type="checkbox" name="activo" id="activo" defaultChecked={client.activo || false} className="h-4 w-4 text-primary border-gray-300 rounded focus:ring-primary" />
